// lib/services/services_pages/logo_design_corporate_identity.dart
...
/// “Logo Tasarımı ve Kurumsal Kimlik” servisi sayfası.
/// services_view.dart içinde page: const LogoDesignCorporateIdentityPage()
/// referansını buradaki class adıyla eşleştirdiğinizden emin olun.
class LogoDesignCorporateIdentityPage extends StatelessWidget {
  ...
  const LogoDesignCorporateIdentityPage({
    Key? key,
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  return Column(
                    ...
                    children: [
                      Text(
                        AppStrings.get('logo_design_page_title', locale),
                      ...
                      Text(
                        AppStrings.get('logo_design_page_sub', locale),
                      ...
                      Center(
                        child: ElevatedButton(
                          ...
                          child: Text(
                            AppStrings.get('logo_design_cta', locale),
  ...
  Widget _buildTextContent(BuildContext context, String locale) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(AppStrings.get('logo_design_para1', locale), style: bodyStyle),
        const SizedBox(height: 16),
        Text(AppStrings.get('logo_design_para2', locale), style: bodyStyle),
        const SizedBox(height: 16),
        Text(AppStrings.get('logo_design_para3', locale), style: bodyStyle),
        const SizedBox(height: 16),
        Text(AppStrings.get('logo_design_para4', locale), style: bodyStyle),
        const SizedBox(height: 16),
        Text(AppStrings.get('logo_design_para5', locale), style: bodyStyle),
        const SizedBox(height: 16),
        Text(AppStrings.get('logo_design_para6', locale), style: bodyStyle),
      ],
    );
  }
