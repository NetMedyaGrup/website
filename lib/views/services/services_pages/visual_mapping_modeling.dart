// lib/services/services_pages/visual_mapping_modeling.dart
...
/// “Görsel Haritalama & 3D Modelleme” servisi sayfası.
/// services_view.dart içinde page: const VisualMappingModelingPage()
/// referansını buradaki class adıyla eşleştirin.
class VisualMappingModelingPage extends StatelessWidget {
  final VoidCallback toggleTheme;
  final Function(Locale) changeLanguage;

  const VisualMappingModelingPage({
    Key? key,
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  return Column(
                    ...
                    children: [
                      Text(
                        AppStrings.get('visual_mapping_page_title', locale),
                      ...
                      Text(
                        AppStrings.get('visual_mapping_page_sub', locale),
                      ...
                      Center(
                        child: ElevatedButton(
                          ...
                          child: Text(
                            AppStrings.get('visual_mapping_cta', locale),
  ...
  Widget _buildTextContent(BuildContext context, String locale) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(AppStrings.get('visual_mapping_para1', locale), style: bodyStyle),
        const SizedBox(height: 16),
        Text(AppStrings.get('visual_mapping_para2', locale), style: bodyStyle),
        const SizedBox(height: 16),
        Text(AppStrings.get('visual_mapping_para3', locale), style: bodyStyle),
        const SizedBox(height: 16),
        Text(AppStrings.get('visual_mapping_para4', locale), style: bodyStyle),
        const SizedBox(height: 16),
        Text(AppStrings.get('visual_mapping_para5', locale), style: bodyStyle),
        const SizedBox(height: 16),
        Text(AppStrings.get('visual_mapping_para6', locale), style: bodyStyle),
        const SizedBox(height: 16),
        Text(AppStrings.get('visual_mapping_para7', locale), style: bodyStyle),
      ],
    );
  }
