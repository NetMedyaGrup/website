// lib/services/services_pages/web_design_dev.dart
...
/// “Web Tasarım ve Geliştirme” servisi sayfası.
/// services_view.dart içinde page: const WebDesignDevPage()
/// referansını buradaki class adıyla eşleştirin.
class WebDesignDevPage extends StatelessWidget {
                ...
                builder: (context, constraints) {
                  ...
                  return Column(
                    ...
                    children: [
                      // Başlık
                      Text(
                        AppStrings.get('web_dev_page_title', locale),
                      ...
                      // Alt başlık
                      Text(
                        AppStrings.get('web_dev_page_sub', locale),
                      ...
                      Center(
                        child: ElevatedButton(
                          ...
                          child: Text(
                            AppStrings.get('web_dev_cta', locale),
  ...
  Widget _buildTextContent(BuildContext context, String locale) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(AppStrings.get('web_dev_para1', locale), style: bodyStyle),
        const SizedBox(height: 16),
        Text(AppStrings.get('web_dev_para2', locale), style: bodyStyle),
        const SizedBox(height: 16),
        Text(AppStrings.get('web_dev_para3', locale), style: bodyStyle),
        const SizedBox(height: 16),
        Text(AppStrings.get('web_dev_para4', locale), style: bodyStyle),
        const SizedBox(height: 16),
        Text(AppStrings.get('web_dev_para5', locale), style: bodyStyle),
        const SizedBox(height: 16),
        Text(AppStrings.get('web_dev_para6', locale), style: bodyStyle),
      ],
    );
  }
  ...
  Widget _buildImage() {
    return ClipRRect(
      ...
      child: Image.asset(
        'assets/images/services/web_design_dev.jpg',
        fit: BoxFit.cover,
      ),
    );
  }
